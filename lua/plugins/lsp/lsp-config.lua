  ...
  config = function()
    ...
    mason_lspconfig.setup({
      ensure_installed = {
        ...
        "graphql",
        "pyright",
        "terraformls", -- ✅ add terraform-ls here for automatic install
      },
    ...
    for _, server_name in ipairs(mason_lspconfig.get_installed_servers()) do
      ...
      elseif server_name == "terraformls" then
        -- ✅ Terraform-specific LSP setup
        opts.cmd = { "terraform-ls", "serve" }
        opts.filetypes = { "terraform", "tf", "terraform-vars" }
        opts.root_dir = lspconfig.util.root_pattern(".terraform", ".git", "*.tf")
      end
